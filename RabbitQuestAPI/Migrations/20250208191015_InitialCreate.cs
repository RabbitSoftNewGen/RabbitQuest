    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuizStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserQuizStatuses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserQuizStatuses_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuizStatuses_QuizId",
                table: "UserQuizStatuses",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_UserQuizStatuses_UserId",
                table: "UserQuizStatuses",
                column: "UserId");
        }
